export const experienceData = {
  ...
  TypeScript: {
    Overview:
      "Possess intermediate proficiency in employing TypeScript for adding static typing to JavaScript, enhancing code quality and readability.",
